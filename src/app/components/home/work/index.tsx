...
const Work = () => {
  return (
    <section id="relative-section" className="relative">
      ...
      <div className="container">
        <div className="text-center mb-14">
          ...
          <p className="text-lightpurple max-w-2xl mx-auto md:text-lg font-normal md:leading-8 capitalize">
            Getting started with Discipline is easy. Install the app, select the apps you want to manage, and 
            set daily time limits. Our smart system tracks your usage, blocks distractions automatically, and 
            helps you build healthier digital habits — all in a few simple steps.
          </p>
        </div>
